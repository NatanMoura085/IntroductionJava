...
public class Match {
    public static void main(String[] args) {
        ...
        System.out.print(alunoFilters.stream().allMatch(media));
        System.out.print(alunoFilters.stream().anyMatch(media));
        System.out.print(alunoFilters.stream().noneMatch(media));
    }
}
